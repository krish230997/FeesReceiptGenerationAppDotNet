<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="NewEmp.aspx.cs" Inherits="Pratice1.NewEmp" %>
...
<body>
        ...
        <div class="auto-style1">
            <table class="form-table">
                ...
                <tr>
                    <th class="auto-style3"><label for="txtDate">Photo:</label></th>
                    <td class="auto-style2">
                        <asp:FileUpload ID="FileUpload1" class="form-control-file" runat="server" /></td>
                </tr>
                <tr>
